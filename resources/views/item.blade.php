		...
		<div class="shop_inner_inf">
			<div class="col-md-4 single-right-left ">
				<div class="grid images_3_of_2">
					...
					<div class="flex-viewport" style="overflow: hidden; position: relative;"><ul class="slides" style="width: 1000%; transition-duration: 0.6s; transform: translate3d(-1203px, 0px, 0px);"><li data-thumb="images/d3.jpg" class="clone" aria-hidden="true" style="width: 401px; float: left; display: block;">
								<div class="thumb-image"> <img src="/lightshop/images/d3.jpg" data-imagezoom="true" class="img-responsive" draggable="false"> </div>
							</li>
							<li data-thumb="/lightshop/images/d2.jpg" style="width: 401px; float: left; display: block;" class="">
								<div class="thumb-image"> <img src="/lightshop/images/d2.jpg" data-imagezoom="true" class="img-responsive" draggable="false"> </div>
							</li>
							<li data-thumb="/lightshop/images/d1.jpg" class="" style="width: 401px; float: left; display: block;">
								<div class="thumb-image"> <img src="/lightshop/images/d1.jpg" data-imagezoom="true" class="img-responsive" draggable="false"> </div>
							</li>
							<li data-thumb="/lightshop/images/d3.jpg" class="flex-active-slide" style="width: 401px; float: left; display: block;">
								<div class="thumb-image"> <img src="/lightshop/images/d3.jpg" data-imagezoom="true" class="img-responsive" draggable="false"> </div>
							</li>
						<li data-thumb="/lightshop/images/d2.jpg" style="width: 401px; float: left; display: block;" class="clone" aria-hidden="true">
								<div class="thumb-image"> <img src="/lightshop/images/d2.jpg" data-imagezoom="true" class="img-responsive" draggable="false"> </div>
							</li></ul></div><ol class="flex-control-nav flex-control-thumbs"><li><img src="/lightshop/images/d2.jpg" class="" draggable="false"></li><li><img src="/lightshop/images/d1.jpg" draggable="false" class=""></li><li><img src="/lightshop/images/d3.jpg" draggable="false" class="flex-active"></li></ol><ul class="flex-direction-nav"><li class="flex-nav-prev"><a class="flex-prev" href="#">Previous</a></li><li class="flex-nav-next"><a class="flex-next" href="#">Next</a></li></ul></div>
				</div>
			</div>
								...
								<div class="bootstrap-tab-text-grids">
									<div class="bootstrap-tab-text-grid">
										<div class="bootstrap-tab-text-grid-left">
											<img src="/lightshop/images/t1.jpg" alt=" " class="img-responsive">
										</div>
